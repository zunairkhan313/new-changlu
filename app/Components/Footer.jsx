        ...
        <div className="container-fluid bg-slate-100 mt-5">
            <div className="container">
                ...
                <div className="row ">
                    ...
                    <div className="col-lg-4 flex flex-wrap justify-center align-center">
                        <div>
                            <h3 className="text-center font-bold tracking-widest text-2xl text-green-800">EXPLORE</h3>
                            <div className="mt-5">
                    ...
                    <div className="col-lg-4 flex flex-wrap justify-center align-center">
                        <div>
                            <h3 className="text-center font-bold tracking-widest text-2xl text-green-800">PRODUCTS</h3>
                            <div className="mt-5">
