...
export default function Home() {
  return (
    <div className="bg-white">
      ...
      <div className="container col-lg-12 relative lg:h-2/3 md:h-2/3">
        <div className="row">
          ...
          <div id='sideb0x' className=" top-[30%] left-[70%] absolute text-center bg-white w-[375px] rounded-s-md">
            <br /><br />
      ...
      <div className="container mt-5">
        ...
        <div className="flex flex-wrap justify-around">
          <div className="mt-5 w-[800px] h-[100%]">
            <CardSliderCarousel />
          </div>
        </div>
      </div>
